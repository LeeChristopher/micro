...
var file_proto_greeter_proto_rawDesc = []byte{
	...
	0x77, 0x61, 0x79, 0x2e, 0x67, 0x72, 0x65, 0x65, 0x74, 0x65, 0x72, 0x1a, 0x1c, 0x67, 0x6f, 0x6f,
	...
	0x09, 0x52, 0x03, 0x6d, 0x73, 0x67, 0x32, 0x6c, 0x0a, 0x07, 0x47, 0x72, 0x65, 0x65, 0x74, 0x65,
	0x72, 0x12, 0x61, 0x0a, 0x05, 0x48, 0x65, 0x6c, 0x6c, 0x6f, 0x12, 0x1d, 0x2e, 0x67, 0x72, 0x70,
	0x63, 0x2e, 0x67, 0x61, 0x74, 0x65, 0x77, 0x61, 0x79, 0x2e, 0x67, 0x72, 0x65, 0x65, 0x74, 0x65,
	0x72, 0x2e, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x1e, 0x2e, 0x67, 0x72, 0x70, 0x63,
	0x2e, 0x67, 0x61, 0x74, 0x65, 0x77, 0x61, 0x79, 0x2e, 0x67, 0x72, 0x65, 0x65, 0x74, 0x65, 0x72,
	0x2e, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x19, 0x82, 0xd3, 0xe4, 0x93, 0x02,
	0x13, 0x22, 0x0e, 0x2f, 0x67, 0x72, 0x65, 0x65, 0x74, 0x65, 0x72, 0x2f, 0x68, 0x65, 0x6c, 0x6c,
...
var file_proto_greeter_proto_goTypes = []interface{}{
	(*Request)(nil),  // 0: grpc.gateway.greeter.Request
	(*Response)(nil), // 1: grpc.gateway.greeter.Response
}
var file_proto_greeter_proto_depIdxs = []int32{
	0, // 0: grpc.gateway.greeter.Greeter.Hello:input_type -> grpc.gateway.greeter.Request
	1, // 1: grpc.gateway.greeter.Greeter.Hello:output_type -> grpc.gateway.greeter.Response
...
func (c *greeterClient) Hello(ctx context.Context, in *Request, opts ...grpc.CallOption) (*Response, error) {
	out := new(Response)
	err := c.cc.Invoke(ctx, "/grpc.gateway.greeter.Greeter/Hello", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Greeter_Hello_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/grpc.gateway.greeter.Greeter/Hello",
	}
...
var _Greeter_serviceDesc = grpc.ServiceDesc{
	ServiceName: "grpc.gateway.greeter.Greeter",
